...
const AdminUserRequestsPage = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await userRequestAdminService.getUserRequests(filterParams) as any;
  ...
  const handleMarkResolved = async (id) => {
    try {
      ...
      toast.error('Error al marcar como resuelta. Intenta de nuevo.');
    }
  };
  ...
  const handleDeleteConfirm = async () => {
    ...
    setIsDeleting(true);
    try {
      await userRequestAdminService.deleteUserRequest(deleteTarget);
