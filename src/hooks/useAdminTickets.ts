...
export const useUpdateAdminTicket = () => {
  ...
  return useMutation({
    mutationFn: ({ id, ticketData }: { id: any; ticketData: any }) => adminTicketsService.update(id, ticketData),
...
export const useDeleteAdminTicket = () => {
  ...
  return useMutation({
    mutationFn: (id: any) => adminTicketsService.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
...
export const useChangeTicketStatus = () => {
  ...
  return useMutation({
    mutationFn: ({ id, status }: { id: any; status: any }) => adminTicketsService.changeStatus(id, status),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
...
export const useChangeTicketPriority = () => {
  ...
  return useMutation({
    mutationFn: ({ id, priority }: { id: any; priority: any }) => adminTicketsService.changePriority(id, priority),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
...
export const useAssignTicket = () => {
  ...
  return useMutation({
    mutationFn: ({ id, agentId }: { id: any; agentId: any }) => adminTicketsService.assign(id, agentId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
...
export const useAddTicketReply = () => {
  ...
  return useMutation({
    mutationFn: ({ id, replyData }: { id: any; replyData: any }) => adminTicketsService.addReply(id, replyData),
    onSuccess: (data, variables) => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
...
export const useCloseTicket = () => {
  ...
  return useMutation({
    mutationFn: ({ id, reason }: { id: any; reason?: any }) => adminTicketsService.close(id, reason),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
...
export const useReopenTicket = () => {
  ...
  return useMutation({
    mutationFn: ({ id, reason }: { id: any; reason?: any }) => adminTicketsService.reopen(id, reason),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: adminTicketsKeys.all });
    },
    onError: (error) => {
