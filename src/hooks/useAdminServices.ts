...
export const useUpdateAdminService = () => {
  ...
  return useMutation({
    mutationFn: ({ id, serviceData }: { id: string | number; serviceData: any }) => adminServicesService.update(id, serviceData),
...
export const useDeleteAdminService = () => {
  ...
  return useMutation({
    mutationFn: (id: string | number) => adminServicesService.delete(id),
    onSuccess: () => {
...
export const useChangeAdminServiceStatus = () => {
  ...
  return useMutation({
    mutationFn: ({ id, status }: { id: string | number; status: string }) => adminServicesService.changeStatus(id, status as any),
    onSuccess: () => {
...
export const useSuspendAdminService = () => {
  ...
  return useMutation({
    mutationFn: ({ id, reason }: { id: string | number; reason?: string }) => adminServicesService.suspend(id, reason),
    onSuccess: () => {
...
export const useReactivateAdminService = () => {
  ...
  return useMutation({
    mutationFn: (id: string | number) => adminServicesService.reactivate(id),
    onSuccess: () => {
      // Invalidar queries de servicios
      queryClient.invalidateQueries({ queryKey: adminServicesKeys.all });
    },
