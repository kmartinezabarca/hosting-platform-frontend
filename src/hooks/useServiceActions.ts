...
export const useServiceActions = () => {
  ...
  const mutation = useMutation({
    mutationFn: async ({ serviceId, action }: { serviceId: any; action: any }) => {
      let res;
      switch (action) {
        case 'start':
        case 'restart':
    ...
    onMutate: async ({ serviceId, action }: { serviceId: any; action: any }) => {
    ...
    onSuccess: (_data, { action }: { serviceId: any; action: any }) => {
