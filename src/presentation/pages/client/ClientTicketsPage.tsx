...
import FiltersBar from "@presentation/components/ui/FiltersBar";
import TicketsHeader from "@presentation/components/features/tickets/TicketsHeader";
import TicketsList from "@presentation/components/features/tickets/TicketsList";
import TicketCreateModal from "@presentation/components/features/tickets/TicketCreateModal";
import { useTicketChat } from "@application/context/TicketChatContext";
import {
  useTickets,
  useCreateTicket,
...
const ClientTicketsPage = () => {
  ...
  const onOpenChat = async (ticket) => {
    try {
      ...
      openChat(full, (full as any)?.replies || []);
    } catch (e) {
      console.error("Error opening ticket:", e);
      openChat(ticket, (ticket as any)?.replies || []);
    }
  };
