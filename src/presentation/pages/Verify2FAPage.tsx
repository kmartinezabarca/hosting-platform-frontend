...
import { useVerify2FA } from '@presentation/components/features/hooks/useAuth';
...
const Verify2FAPage = () => {
  ...
  const { mutateAsync: verifyTwoFactor, isPending: isLoading } = useVerify2FA();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await verifyTwoFactor({ code, email });
