...
// import apiClient from '@shared/utils/apiClient'; // descomenta para llamadas reales

/** ---------- UI PRIMITIVES: MODALES ---------- */

const BaseModal = ({ open, onClose, title, headerDescription = undefined, children }: any) => {
...
const DangerZoneTab = ({ service }: any) => {
