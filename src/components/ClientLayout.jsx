...
import {
  Home, Package, CreditCard, FileText, MessageSquare, Settings, LogOut,
  Menu, X, ChevronDown, Bell, User, HelpCircle,
  Sun, Moon, Zap, Shield
} from 'lucide-react';
...
const ClientLayout = () => {
  ...
  const menuItems = [
    ...
    { icon: Package, label: 'Servicios', path: '/client/services' },
    { icon: CreditCard, label: 'Facturación', path: '/client/billing' },
    { icon: FileText, label: 'Facturas', path: '/client/invoices' },
    { icon: MessageSquare, label: 'Soporte', path: '/client/support' },
  ...
  const isNewDashboard = location.pathname === '/client/dashboard';
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        ...
        <div className="lg:pl-64">
          ...
          <main className="flex-1">
            {isNewDashboard ? <NewDashboard /> : <Outlet />}
          </main>
        </div>
      </div>
    </div>
