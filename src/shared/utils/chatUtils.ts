import type { TicketStatus } from '@core/entities/models';
...
export const isImageMime = (mime = ''): boolean => /^image\//.test(mime);
...
export const getStatusBadge = (status: TicketStatus | string): StatusBadge => {
