...
import adminServicePlansService from '@presentation/components/features/services/adminServicePlansService';
...
export const useUpdateAdminServicePlan = () => {
  ...
  return useMutation({
    mutationFn: ({ uuid, planData }: { uuid: string; planData: any }) => adminServicePlansService.update(uuid, planData),
